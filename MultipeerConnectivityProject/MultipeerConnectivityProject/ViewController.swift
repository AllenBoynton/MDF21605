...
class ViewController: UIViewController, MCBrowserViewControllerDelegate, MCSessionDelegate, UITextFieldDelegate {
    ...
    func instructionAlert() -> Bool {
        ...
        if friendSearch.enabled == true {
            ...
            let alertUser = UIAlertController(title: "Attention", message: "To start, first tap the \"Friends\" button to search for local opponent. Once chosen and confirmed, you may then tap the \"Play Now\" button to start your game. Have fun!!", preferredStyle: UIAlertControllerStyle.Alert)
